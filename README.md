...
- Course duration: Tuesday, March 1st, 2022 - Saturday, August 27th, 2022 (25 weeks 4 days)
- Holidays:
...
[Link to join the Zoom Room](https://generalassembly.zoom.us/j/97170865548?pwd=VndxeWZvMDJkOCtqYVhvWmR0dC9Ldz09)

[Link to the recording tracker](https://docs.google.com/spreadsheets/d/1c9n0Vus2FsHuHZdIR-8WwjAPmfQx9AidLws2GkSdptQ/edit#gid=0)
...
### 6. Deliverables/Homework!

A Deliverable is an assignment that is required to be submitted as instructed to your instructors.

Unless otherwise stated, no deliverable will be accepted past its due date, which is typically 1 week from when the deliverable was assigned. That said, deliverables are a great check to make sure you're keeping up with course material so the ideal date is within 24-48 hours of being assigned the task.
...
[Repo to submit Deliverables](https://git.generalassemb.ly/sei-toronto/sei-49-hw)
...
- [LeetCode](https://www.leetcode.com/) <- generally quite difficult interview questions: i recommend starting with easy ones, with around ~90% acceptance.. then work your way down to easy with 80%, etc.... the easy with 50% acceptance are almost impossible for a beginner to attempt!
