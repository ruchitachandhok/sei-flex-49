...
This lab continues where the Dom Access Menu Lab left off and provides practice defining event listeners used to manipulate the DOM in response to user interaction.  It also provides additional practice styling DOM elements dynamically using JavaScript.

### This lab is NOT a deliverable.

## Setup

1. Continue to use the "DOM Lab" HTML/CSS/JS Repl you created for the Dom Access (Menu) Lab.  This is what you should have thus far:

<img src="https://i.imgur.com/pWu6yHO.png">

If what you have doesn't match, you can copy over the solution from the Dom Access Lab.
...
2. Insert an additional `<nav>` element within the `<header>` element in **index.html**:
	...
	> Note: Other than the above changes, **DO NOT** modify **index.html** in any way. (except, perhaps, to add "id" attributes)
